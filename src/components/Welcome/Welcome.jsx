  ...
  return (
    <Container sx={{ mt: 5, textAlign: 'center' }}>
      ...
      <Typography variant="body1" paragraph sx={{ mb: 4, color: 'text.secondary' }}>
        Celestial Reads is a modern digital library platform designed to simplify book discovery and management.
        ...
        filtering, and sorting features to help users quickly find what they need. With a clean and intuitive interface,
         Celestial Reads makes reading more accessible and organized for everyone.
      </Typography>
